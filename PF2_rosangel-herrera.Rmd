...
```
Ya en la siguiente gráfica, podemos observar los años y la selección ganadora junto a la cantidad de goles obtenidos en el partido final de esa edición del torneo. En el cual, se ve una tendencia a marcar más de dos goles por partes de los campeones con una excepción muy particular en el año 1994 con la cuarta copa de `Brasil` cuyo enfrentamiento versus la selección de `Italia` terminó en un empate 0-0 y fue a través de las tandas de penales que este logró obtener el título cerrando el marcador en 0(3) – 0(2) en el torneo realizado en Estados Unidos.
```{r}
